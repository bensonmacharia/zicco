...
Route::group(['middleware' => ['auth']], function() {
    ...
    Route::get('product/stock', [App\Http\Controllers\StockController::class, 'index'])->name('stock');
    ...
    Route::get('report/sales', [App\Http\Controllers\ReportsController::class, 'index'])->name('turnover');
